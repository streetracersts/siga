            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <button @click="abreFormAdicionar()" class="btn btn-primary btn-xs pull-right">+ Nova</button>
                    </div>
                    <div class="card-body">
                        <table class="table table-bordered table-striped table-responsive">
                            <tbody>
                                ...
                                <tr v-for="(pessoa, index) in lista" :key="pessoa.id">
                                    ...
                                    <td>
                                        <button @click="abreEditarModal(index)"
                                            class="btn btn-success btn-xs">Editar</button>
                                        <button @click="excluiPessoa(index)"
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <select name="tipopessoa" id="tipopessoa" v-model="tipopessoa.id_tipo_pessoa">
                                        <option disabled value>Selecione uma opção</option>
                                        <option v-for="tipo in tipopessoa" :key="tipo.id" :value="tipo.id">{{ tipo.tipo
                                            }}</option>
                                    </select>
                                </div>
                            </div>
                            <div v-if="tipopessoa.id_tipo_pessoa > 0" class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="apelido" id="apelido" class="form-control"
                                        v-model="pessoa.apelido" v-validate="'required'" />
                            ...
                            <div v-if="tipopessoa.id_tipo_pessoa > 0" class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nome_razao" id="nome_razao" placeholder
                                        class="form-control" v-model="pessoa.nome_razao" />
                                </div>
                            </div>
                            <div v-if="tipopessoa.id_tipo_pessoa === 1" class="col-md-6">
                                <div class="form-group">
                                    <label for="cnpj">CNPJ:</label>
                                    <input type="text" name="cnpj" id="cnpj" placeholder="__.___.___-_____/__"
                                        class="form-control" v-model="pessoa.cnpj" v-mask="'##.###.###/####-##'" />
                            ...
                            <div v-if="tipopessoa.id_tipo_pessoa >= 2" class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="cpf" id="cpf" placeholder="___.___.___-__"
                                        class="form-control" v-model="pessoa.cpf" v-mask="'###.###.###-##'" />
                                    <span>{{ errors.field }}</span>
                                </div>
                            </div>
                            ...
                            <div v-if="tipopessoa.id_tipo_pessoa > 0" class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="complemento" id="complemento" placeholder
                                        class="form-control" v-model="pessoa.complemento" />
                                </div>
                            </div>
                            ...
                            <div v-if="tipopessoa.id_tipo_pessoa > 0" class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="uf" id="uf" placeholder="" class="form-control"
                                        v-model="pessoa.uf" />
                                </div>
                            </div>
                            <div v-if="tipopessoa.id_tipo_pessoa > 0" class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="pais" id="pais" placeholder="" class="form-control"
                                        v-model="pessoa.pais" />
                                </div>
                            </div>
                            <div v-if="tipopessoa.id_tipo_pessoa > 0" class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="telefone" id="telefone" placeholder="()____-____"
                                        class="form-control" v-model="pessoa.telefone1" v-validate="'required'"
                                        v-mask="['(##)####-####', '(##)#####-####']" />
                            ...
                            <div v-if="tipopessoa.id_tipo_pessoa > 0" class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="telefone2" id="telefone2" placeholder="()____-____"
                                        class="form-control" v-model="pessoa.telefone2"
                                        v-mask="['(##)####-####', '(##)#####-####']" />
                                </div>
                            </div>
                            <div v-if="tipopessoa.id_tipo_pessoa > 0" class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="email" id="email" placeholder="email@domínio"
                                        class="form-control" v-model="pessoa.email" v-validate="'email'" />
                            ...
                            <div v-if="tipopessoa.id_tipo_pessoa >= 2" class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="o_emissor" id="o_emissor" class="form-control"
                            ...
                            <div v-if="tipopessoa.id_tipo_pessoa >= 2" class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="data_emissao" id="data_emissao" placeholder="__/__/____"
                                        class="form-control" v-model="pessoa.data_emissao" v-mask="'##/##/####'" />
                                </div>
                            </div>
                            <div v-if="tipopessoa.id_tipo_pessoa >= 2" class="col-md-6">
                                <div  class="form-group">
                            ...
                            <div v-if="tipopessoa.id_tipo_pessoa == 3" class="col-md-4">
                                <div  class="form-group">
                                    ...
                                    <input type="text" name="cnh" id="cnh" class="form-control" v-model="pessoa.cnh" />
                                </div>
                            </div>
                            <div v-if="tipopessoa.id_tipo_pessoa == 3" class="col-md-1">
                                <div  class="form-group">
                                    <label for="cnh_categoria">Categoria CNH:</label>
                                    <input type="text" name="cnh_categoria" id="cnh_categoria" class="form-control"
                            ...
                            <div v-if="tipopessoa.id_tipo_pessoa >= 2" class="col-md-3">
                                <div  class="form-group">
                                    ...
                                    <input type="text" name="data_nascimento" id="data_nascimento" placeholder="__/__/___"
                                      class="form-control" v-model="pessoa.data_nascimento" v-mask="'##/##/####'" />
                                </div>
                            </div>
                            <div v-if="tipopessoa.id_tipo_pessoa == 3" class="col-md-2">
                                <div class="form-group">
                                    <label for="numeroCtps">Número CTPS:</label>
                                    <input type="text" name="numeroCtps" id="numeroCtps" placeholder class="form-control"
                            ...
                            <div v-if="tipopessoa.id_tipo_pessoa == 3" class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="serieCtps" id="serieCtps" placeholder class="form-control"
                            ...
                            <div v-if="tipopessoa.id_tipo_pessoa == 3" class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="pis" id="pis" placeholder class="form-control" v-model="pessoa.pis" />
                                </div>
                            </div>
                            <div v-if="tipopessoa.id_tipo_pessoa == 3" class="col-md-3">
                                <div class="form-group">
                                    <label for="salario">Salário:</label>
                                    <input type="text" name="salario" id="salario" placeholder="0,00" class="form-control"
                                      v-model="pessoa.salario" v-mask="'#,##'" />
                                </div>
                            </div>
                            <div v-if="tipopessoa.id_tipo_pessoa == 3" class="col-md-3">
                                <div class="form-group">
                                    <label for="nomePai">Nome do pai:</label>
                                    <input type="text" name="nomePai" id="nomePai" placeholder class="form-control"
                            ...
                            <div v-if="tipopessoa.id_tipo_pessoa == 3" class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nomeMae" id="nomeMae" placeholder class="form-control"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea cols="30" rows="5" class="form-control" placeholder="Task Description"
                                v-model="atualizaPessoa.rg"></textarea>
                        </div>
                    </div>
                    <div class="modal-footer">
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            ativarBotao() {
                if (this.pessoa.apelido.length > 0 && this.pessoa.telefone1.length >= 13) {
