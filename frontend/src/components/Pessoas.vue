            ...
            <table class="table table-bordered table-striped table-responsive">
              <tbody>
                ...
                <tr v-for="(pessoa, index) in lista" :key="pessoa.id">
                  ...
                  <td>
                    <button @click="abreEditarModal(index)" class="btn btn-success btn-xs">Editar</button>
                    <button @click="excluiPessoa(index)" class="btn btn-danger btn-xs">Excluir</button>
                  </td>
                </tr>
              </tbody>
            </table>
          ...
          <div class="modal-body">
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                  <select name="tipopessoa" id="tipopessoa" v-model="tipopessoa.id_tipo_pessoa">
                    ...
                    <option v-for="tipo in tipopessoa" :key="tipo.id" :value="tipo.id">{{ tipo.tipo }}</option>
                  </select>
                </div>
              </div>
              ...
              <div class="col-md-6">
                ...
                <div v-if="tipopessoa.id_tipo_pessoa == 3" class="form-group">
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="form-group">
              <label>Name:</label>
              <input type="text" placeholder="Task Name" class="form-control" v-model="atualizaPessoa.nome" />
            </div>
            <div class="form-group">
